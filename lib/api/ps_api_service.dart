...
import 'package:fluttermultistoreflutter/api/ps_url.dart';
...
import 'package:fluttermultistoreflutter/viewobject/comment_detail.dart';
...
import 'package:fluttermultistoreflutter/viewobject/rating.dart';
...
import 'package:fluttermultistoreflutter/viewobject/transaction_detail.dart';
...
class PsApiService extends PsApi {
  ...
  /// Get Shipping Method
  ///
  Future<PsResource<List<ShippingMethod>>> getShippingMethod(
      String shopId) async {
    final String url =
        '${PsUrl.ps_shipping_method_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId';
  ...
  Future<PsResource<List<SubCategory>>> getSubCategoryList(
      int limit, int offset, String categoryId, String shopId) async {
    final String url =
        '${PsUrl.ps_subCategory_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId/limit/$limit/offset/$offset/cat_id/$categoryId';
  ...
  Future<PsResource<List<SubCategory>>> getAllSubCategoryList(
    ...
    final String url =
        '${PsUrl.ps_subCategory_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId/cat_id/$categoryId';
  ...
  Future<PsResource<List<ShopCategory>>> getShopCategoryList(
      int limit, int offset, String shopId) async {
    final String url =
        '${PsUrl.ps_shop_category_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId/limit/$limit/offset/$offset';

    return await getServerCall<ShopCategory, List<ShopCategory>>(
        ShopCategory(), url);
  }
  ...
  Future<PsResource<List<ShopTag>>> getShopTagList(
      int limit, int offset) async {
    final String url =
        '${PsUrl.ps_shop_tag_url}/api_key/${PsConfig.ps_api_key}/limit/$limit/offset/$offset';

    return await getServerCall<ShopTag, List<ShopTag>>(ShopTag(), url);
  }

  Future<PsResource<List<Shop>>> getShopListByTagId(
      int limit, int offset, String tagId) async {
    final String url =
        '${PsUrl.ps_get_shop_by_tagid_url}/api_key/${PsConfig.ps_api_key}/tag_id/$tagId';

    return await getServerCall<Shop, List<Shop>>(Shop(), url);
  }

  Future<PsResource<Product>> getProductDetail(
      String productId, String loginUserId, String shopId) async {
    final String url =
        '${PsUrl.ps_product_detail_url}/api_key/${PsConfig.ps_api_key}/id/$productId/shop_id/$shopId/login_user_id/$loginUserId';
  ...
  Future<PsResource<List<Product>>> getRelatedProductList(String productId,
      String categoryId, String shopId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_relatedProduct_url}/api_key/${PsConfig.ps_api_key}/id/$productId/shop_id/$shopId/cat_id/$categoryId/limit/$limit/offset/$offset';
    print(url);
  ...
  Future<PsResource<List<ProductCollectionHeader>>> getProductCollectionList(
    ...
    final String url =
        '${PsUrl.ps_collection_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId/limit/$limit/offset/$offset';
  ...
  Future<PsResource<List<Blog>>> getBlogListByShopId(
      String shopId, int limit, int offset) async {
    final String url =
        '${PsUrl.ps_bloglist_url}/api_key/${PsConfig.ps_api_key}/shop_id/$shopId/limit/$limit/offset/$offset';
