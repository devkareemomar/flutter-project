...
class PsTextFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   children: <Widget>[
    //     Text(titleText, style: Theme.of(context).textTheme.bodyText1),
    //     Text(' *', style: Theme.of(context).textTheme.bodyText1.copyWith(color: PsColors.mainColor))
    //   ],
    // );
    ...
    //         ? Theme.of(context).textTheme.bodyText2.copyWith(color: PsColors.textPrimaryLightColor)
