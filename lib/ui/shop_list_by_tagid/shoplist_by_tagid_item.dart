...
class ShopListByTagIdItem extends StatelessWidget {
  const ShopListByTagIdItem(
      {Key key,
      @required this.shop,
      this.onTap,
              ...
              child: Transform(
                  ...
                  child: GestureDetector(
                      ...
                      child: Container(
                          ...
                          child: ShopListByTagIdItemWidget(shop: shop)))));
        });
  }
}

class ShopListByTagIdItemWidget extends StatelessWidget {
  const ShopListByTagIdItemWidget({
    Key key,
    @required this.shop,
  }) : super(key: key);
