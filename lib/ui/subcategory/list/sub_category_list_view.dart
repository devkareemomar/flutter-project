...
import 'package:fluttermultistoreflutter/ui/subcategory/item/sub_category_vertical_list_item.dart';
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _subCategoryProvider.nextSubCategoryList(
            widget.category.id, _subCategoryProvider.psValueHolder.shopId);
      }
    });
  }
    ...
    return Scaffold(
            ...
            body: ChangeNotifierProvider<SubCategoryProvider>(
              ...
              _subCategoryProvider.loadSubCategoryList(widget.category.id,
                  _subCategoryProvider.psValueHolder.shopId);
