...
import 'package:fluttermultistoreflutter/repository/token_repository.dart';
        ...
        providers: <SingleChildWidget>[
          ...
          ChangeNotifierProvider<TokenProvider>(
              ...
              create: (BuildContext context) {
                ...
                tokenProvider.getToken(valueHolder.shopId);
          ...
          ChangeNotifierProvider<ShippingMethodProvider>(
              ...
              create: (BuildContext context) {
                ...
                shippingMethodProvider
                    .loadShippingMethodList(valueHolder.shopId);
