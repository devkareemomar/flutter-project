...
import 'package:fluttermultistoreflutter/ui/common/smooth_star_rating_widget.dart';
        ...
        child: MultiProvider(
          ...
          ChangeNotifierProvider<RelatedProductProvider>(
              ...
              create: (BuildContext context) {
                ...
                relatedProductProvider.loadRelatedProductList(widget.product.id,
                    widget.product.catId, widget.product.shopId);
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                GestureDetector(
                    ...
                    child:
                        (productDetail.productDetail.data.overallRating != '0')
                            ? Row(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text(
                ...
                if (productDetail.productDetail.data.isAvailable == PsConst.ONE)
                  Text(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: PSButtonWithIconWidget(
                          ...
                          onPressed: () async {
                            if (widget.product.isAvailable == PsConst.ONE) {
                              _showDrawer(false);
                            } else {
                              showDialog<dynamic>(
                                  context: context,
...
class _IconAndTextWidgetState extends State<_IconAndTextWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.product.minimumOrder == '0') {
      widget.product.minimumOrder = PsConst.ONE;
    }
