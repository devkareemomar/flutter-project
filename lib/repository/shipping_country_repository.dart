...
class ShippingCountryRepository extends PsRepository {
  ...
  Future<dynamic> getAllShippingCountryList(
    ...
    final Finder finder = Finder(filter: Filter.equals( 'shop_id',holder.shopId));
  ...
  Future<dynamic> getNextPageShippingCountryList(
    ...
    if (isConnectedToInternet) {
      ...
      shippingCountryListStream.sink.add(await _shippingCountryDao.getAll(finder: finder,));
    }
  }
}
