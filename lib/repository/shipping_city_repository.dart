...
class ShippingCityRepository extends PsRepository {
  ...
  Future<dynamic> getAllShippingCityList(
    ...
    final Finder finder = Finder(filter: Filter.equals( 'country_id',holder.countryId));
    ...
    if (isConnectedToInternet) {
      ...
      shippingCityListStream.sink.add(await _shippingCityDao.getAll(finder: finder));
    }
  }
